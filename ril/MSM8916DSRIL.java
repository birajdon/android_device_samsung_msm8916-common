...
/**
 * Qualcomm RIL for Samsung MSM8916 based Variants
 * {@hide}
 */
public class MSM8916DSRIL extends RIL {

    private static final int RIL_REQUEST_DIAL_EMERGENCY = 10001;
    private static final int RIL_UNSOL_ON_SS_LL = 11055;

    public MSM8916DSRIL(Context context, int networkMode, int cdmaSubscription) {
        super(context, networkMode, cdmaSubscription, null);
        mQANElements = 6;
    }

    public MSM8916DSRIL(Context context, int preferredNetworkType,
